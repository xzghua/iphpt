<div class="post-<?php  echo $article->ID;  ?> post category-<?php  echo $article->Category->Name;  ?>" id="post-<?php  echo $article->ID;  ?>"> 
       <div class="post-list"> 
        ...
        <div class="post-meta"> 
         ...
         <span class="pcate"><i class="icon-category"></i><a href="<?php  echo $article->Category->Url;  ?>" title="查看<?php  echo $article->Category->Name;  ?>中的全部文章" rel="category tag"><?php  echo $article->Category->Name;  ?></a></span> 
