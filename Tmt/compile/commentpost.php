...
<div id="respond" class="respond">
    ...
    <form method="post" id="comment_form" class="bl_form" target="_self" action="<?php  echo $article->CommentPostUrl;  ?>">
        ...
        <div id="input-box">
            ...
            <div id="author-input">
                ...
                <p id="author-info">
                    ...
                    <input type="text" name="inpName" id="inpName" class="label_better replytext text" value="<?php  echo $user->Name;  ?>"
                    size="28" tabindex="1"  data-new-placeholder="能选个好听的名字不" placeholder="nickname" required />
                    <label for="email">
                        邮箱
                    </label>
                    <input type="text" name="inpEmail" id="inpEmail" class="label_better replytext text" value="<?php  echo $user->Email;  ?>"
                    ...
                    <input type="text" name="inpHomePage" id="inpHomePage" class="label_better replytext text" value="<?php  echo $user->HomePage;  ?>" size="28"
