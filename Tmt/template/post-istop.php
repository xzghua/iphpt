<div class="post-{$article.ID} post category-{$article.Category.Name}" id="post-{$article.ID}"> 
	   ...
	   <span class="post-sticky"></span>
        ...
        <div class="post-meta"> 
         ...
         <span class="pcate"><i class="icon-category"></i><a href="http://www.iphpt.com" title="查看{$article.Category.Name}中的全部文章" rel="category tag">{$article.Category.Name}</a></span> 
